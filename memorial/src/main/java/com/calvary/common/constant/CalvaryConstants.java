...
public class CalvaryConstants {
	...
	/** 동산 배정 상태 : 사용신청 */
	public static final String GRAVE_ASSIGN_STATUS_REQUESTED = "REQUESTED";
	/** 동산 배정 상태 : 사용가능 */
	...
	/** 분양 진행상태 코드값 : 취소 */
	public static final String PROGRESS_STATUS_CA = "CA";
	/** 분양 진행상태 코드값 : 취소 */
	public static final String PROGRESS_STATUS_DEL = "DEL";
