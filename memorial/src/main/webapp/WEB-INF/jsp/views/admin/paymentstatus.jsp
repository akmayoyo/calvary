...
function _downloadExcel() {
	...
	var excelFields = ["bunyang_seq","apply_user_name","use_user_exp","product_type_name","couple_type_count","single_type_count","total_price","down_payment","balance_payment","use_approval_date"];
	var searchKeys = [""];
	var searchValues = [""];
	var queryId = "admin.getBunyangList";
	var fileName = "대금납부현황.xlsx";
