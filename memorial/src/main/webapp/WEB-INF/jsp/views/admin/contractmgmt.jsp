			...
			<div class="row">
				...
				<div class="col-xs-2 col-md-2 pr-10 pl-0">
					<select name="progressStatus" class="form-control">
						...
						<option value="C0" <c:if test="${searchVo.progressStatus == 'C0'}">selected</c:if>>완납(미승인)</option>
...
function _downloadExcel() {
	var excelHeaders = ["번호","신청자","연락처","사용자","신청형태","부부형","1인형","총분양대금","상태","납부금액","계약여부","완납여부","처리일자"];
